function [exitflag,guess] = resonance_Ro0oS_Vk_gen(u1,u2,k,m,n,A2bar,A1,A2,guess, A11_guess)
    ...
    u21a=A12*u12/A21;
    u21b=u12+sqrt(ks*(m*(A21.^(m+1)-A12.^(m+1))/((m+1)*A2bar.^m)+...
    ...
    if exit1 > 0 && (u11-c11)>(u1-c1) &&  A1>=A11 && A22>A2 && (u2+c2)<rS && rS<(u22+c22) && ks<=k && ks>=1 &&...
            A11<=A22 && isreal(A12) && isreal(A21) && isreal(A22)&& isreal(ks)&& u12-c12>0 && u21+c21>0
        disp(['exit1: ' num2str(exit1)]);
        exitflag = 1;
        guess = [ks,A12,A21,A22];
    end
    ...
    if exit2 > 0 && (u11-c11)>(u1-c1) &&  A1>=A11 && A22>A2 && (u2+c2)<rS && rS<(u22+c22) && ks<=k && ks>=1 &&...
            A11<=A22 && isreal(A12) && isreal(A21) && isreal(A22)&& isreal(ks)&& u12-c12>0 && u21+c21>0
   ...
   [S,~,exit3]=fsolve(@Ro0oS3,guess);
    ...
    if exit3 > 0 && (u11-c11)>(u1-c1) &&  A1>=A11 && A22>A2 && (u2+c2)<rS && rS<(u22+c22) && ks<=k && ks>=1 &&...
            A11<=A22 && isreal(A12) && isreal(A21) && isreal(A22)&& isreal(ks)&& u12-c12>0 && u21+c21>0
   ...
   [S,~,exit4]=fsolve(@Ro0oS4,guess);
    ...
    if exit4 > 0 && (u11-c11)>(u1-c1) &&  A1>=A11 && A22>A2 && (u2+c2)<rS && rS<(u22+c22) && ks<=k && ks>=1 &&...
            A11<=A22 && isreal(A12) && isreal(A21) && isreal(A22)&& isreal(ks)&& u12-c12>0 && u21+c21>0
