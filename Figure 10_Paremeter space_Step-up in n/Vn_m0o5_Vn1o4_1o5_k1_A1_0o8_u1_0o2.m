...
guess_Ro0oS = [1.4517    0.1000    0.2174    0.2559];
guess_Ro0oR = [1.4517    0.1000    0.2174    0.2559];
guess_RoSS = [0.0721    0.1182];
guess_RoSR = [0.0721    0.1182];

A22_guess=1.3;
A21_guess=A22_guess;
guess_So0oR = [ 1.4025    1.9996    1.9946    1.4885];
