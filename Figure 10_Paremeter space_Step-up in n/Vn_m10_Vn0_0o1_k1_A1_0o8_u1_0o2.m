...
A2bar= 1;
k=1;
m=10; % Go to classical_Vn_gen.m and choose the appropriate initial guess for the classical case
n1=0;
n2=0.1;
...
A11_guess = 1.05;
A12_guess = A11_guess;
guess_Ro0oS = [0.0914    0.3732    0.7188    0.72411];
guess_Ro0oR = [0.0905    0.3848    0.7214    0.7271];
guess_RoSS = [0.3679    0.5188];
guess_RoSR = [0.3679    0.5188];

A22_guess=1.3;
A21_guess=A22_guess;
guess_So0oR = [0.0914    1.9996    1.9946    1.4885];
