...
A11_guess = 1.05;
A12_guess = A11_guess;
guess_Ro0oS = [0.5182    0.1313    0.1684    0.1695];
guess_Ro0oR = [0.5182    0.1313    0.1684    0.1695];
guess_RoSS = [0.1415    0.1616];
guess_RoSR = [0.3079    0.3739];

A22_guess=1.3;
A21_guess=A22_guess;
guess_So0oR = [0.5046    2.0696  1.8754   1.6666];
guess_SSoR = [2.1696    1.5666];
