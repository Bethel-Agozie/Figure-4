...
k=1;
m1=9.9;
m2=10; % Go to classical_Vm_gen.m and choose the appropriate initial guess for the classical case
n=0;

% Initial guesses for resonant cases
A11_guess = 1.05;
A12_guess = A11_guess;
guess_Ro0oS = [9.9974    0.6226    0.6570    0.6573];
guess_Ro0oR = [9.9053    0.6329    0.6443    0.6579];
guess_RoSS = [0.6225    0.6553]; 
guess_RoSR = [0.6225    0.6569 ];

A22_guess=1.3;
A21_guess=A22_guess;
guess_So0oR = [9.9974    2.0696  1.8754   1.6666];
