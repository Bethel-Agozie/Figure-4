...
A2bar= 1;
k=1.1;
m=0.5; % Go to classical_Vk_gen.m and choose the appropriate initial guess for the classical case
n=0;

% Initial guesses for resonant cases
A11_guess = 1.05;
A12_guess = A11_guess;
guess_Ro0oS = [1.0848    0.3326    0.5337    0.5455];
guess_Ro0oR = [1.0848    0.3326    0.5337    0.5455];
guess_RoSS = [0.3247    0.5216];
guess_RoSR = [0.3247    0.5340];

A22_guess=1.3;
A21_guess=A22_guess;
guess_So0oR = [1.0653    2.2829    1.9089    1.7975];
guess_SSoR = [2.2829    1.7975];
